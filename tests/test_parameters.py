...
def expected_lmoments():
    ...
    return [5.488888888888889, 1.722222222222222, -0.06451612903225806, -0.0645161290322581, -0.0645161290322581]
...
def wakeby_parameters():
    ...
    return [4.51860465116279, 4.00999858552907, 3.296933739370589, 6.793895411225928, -0.49376393504801414]
...
class TestExponentialMethod:
    ...
    def test_exponential_valid_inputs(self, exponential_lmoments, exponential_parameters):
        """
...
class TestGeneralizedLogisticMethod:
    ...
    def test_generalized_logistic_valid_inputs(self, generalized_logistic_lmoments, generalized_logistic_parameters):
        """
        ...
        np.testing.assert_almost_equal(result, generalized_logistic_parameters, decimal=4)
...
class TestGeneralizedNormalMethod:
    ...
    def test_generalized_normal_valid_inputs(self, generalized_normal_lmoments, generalized_normal_parameters):
        """
...
class TestGeneralizedParetoMethod:
    ...
    def test_generalized_pareto_valid_inputs(self, generalized_pareto_lmoments, generalized_pareto_parameters):
        """
